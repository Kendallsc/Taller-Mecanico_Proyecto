...
public class TallerMecanico {
    ...
    public void insertarAuto(String modelo, String placa, boolean marchamo, boolean rtv, boolean golpes, String notasAdicionales) {
        gestionAutos.insertarAuto(modelo, placa, marchamo, rtv, golpes, notasAdicionales);
        System.out.println("Auto insertado correctamente en la base de datos.");
    }
    ...
    public void modificarAuto(int id, String modelo, String placa, boolean marchamo, boolean rtv, boolean golpes, String notasAdicionales) {
        ...
        System.out.println("Auto modificado correctamente en la base de datos.");
    }

    public void eliminarAuto(int id) {
        gestionAutos.eliminarAuto(id);
        System.out.println("Auto eliminado correctamente de la base de datos.");
    }
